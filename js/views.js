              ...
              <div class="hero-layout">
                <div class="hero-front">
                  ...
                  <div class="social-dock" aria-label="Социальные сети Elysium">
                    ...
                    <button class="social-verify-btn" type="button" data-target="verify"><span aria-hidden="true">◆</span> Shield</button>
                  </div>
                </div>
                ...
                <div class="staff-grid staff-pair-strip" aria-label="Команда Elysium">
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("crown", "staff-role-mark")} Создатель проекта</div>
                      <h3>HikaruAL</h3>
                  ...
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("shield", "staff-role-mark")} Главный Администратор</div>
                      <h3>Onelsey</h3>
                  ...
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("brick", "staff-role-mark")} Модератор</div>
                      <h3>Soul</h3>
