    ...
    function groupGlyph(title) {
      ...
      if (value.includes("чат") || value.includes("общен")) return "chat";
      if (value.includes("администр") || value.includes("наказан")) return "balance";
      if (value.includes("медиа")) return "media";
      if (value.includes("время") || value.includes("флуд")) return "pulse";
      if (value.includes("ссыл") || value.includes("реклам")) return "link";
      if (value.includes("механ") || value.includes("команд")) return "system";
      if (value.includes("запрещ") || value.includes("огранич")) return "block";
      return "shield";
    }
    ...
    function groupBlock(group) {
      const [, title, desc, rules] = group;
      return `
        <section class="rule-group">
          <div class="group-head">
            <div class="group-kicker">${glyph(groupGlyph(title), "group-glyph")} Elysium Rules</div>
              ...
              <div class="hero-layout">
                <div class="hero-front">
                  ...
                  <div class="hero-primary-actions">
                    <button class="main-btn green" type="button" data-target="elysium-start">Начать играть</button>
                    <button class="main-btn secondary" type="button" data-target="rules">Открыть правила</button>
                  </div>

                  <div class="social-dock" aria-label="Социальные сети Elysium">
                    <span class="social-label">Мы на связи</span>
                    <a class="social-link telegram" href="https://t.me/elysiummcbe" target="_blank" rel="noopener noreferrer">Telegram</a>
                    <a class="social-link discord" href="https://discord.gg/AFTPbpSN7X" target="_blank" rel="noopener noreferrer">Discord</a>
                    <button class="social-verify-btn" type="button" data-target="verify">${glyph("shield", "social-shield-glyph")} Shield</button>
                  </div>
                </div>

                <aside class="hero-console" aria-label="Подключение к серверу">
                  <div class="console-top"><span>ELYSIUM NODE</span><b class="checking" data-server-status><i></i><span>ПРОВЕРЯЕМ</span></b></div>
                  <div class="console-core">
                    <div class="console-network checking" data-server-network aria-hidden="true">
                      <span class="network-node">E</span><i class="network-path"><b></b></i><span class="network-node shield">S</span><i class="network-path"><b></b></i><span class="network-node">W</span>
                    </div>
                    <span class="console-label">Java Edition</span>
                    <strong>elysiumjava.ru</strong>
                    <div class="console-meta">
                      <small>Purpur 1.21.11 · Защита Elysium Shield</small>
                      <div class="console-signal checking" data-server-signal aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></div>
                    </div>
                  </div>
                  <div class="console-actions">
                    <button type="button" data-copy="elysiumjava.ru">Скопировать IP</button>
                    <button type="button" data-target="verify">Верификация</button>
                  </div>
                </aside>
              </div>

              <button class="scroll-down-btn" type="button" data-scroll-target=".home-grid" aria-label="Перейти к разделам">
                <span>Возможности</span><span class="scroll-arrow">↓</span>
              </button>


              <div class="home-grid">
                <article class="home-card start-card">
                  <div class="icon">${glyph("launch")}</div>
                  <h2>Начать играть</h2>
                  <p>
                ...
                <article class="home-card">
                  <div class="icon">${glyph("rules")}</div>
                ...
                <article class="home-card">
                  <div class="icon">${glyph("support")}</div>
                ...
                <div class="staff-grid staff-pair-strip" aria-label="Команда Elysium">
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("owner", "staff-role-mark")} Создатель проекта</div>
                      <h3>HikaruAL</h3>
                  ...
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("admin", "staff-role-mark")} Главный Администратор</div>
                      <h3>Onelsey</h3>
                  ...
                  <article class="staff-card">
                    ...
                    <div class="staff-info">
                      <div class="staff-role">${glyph("moderator", "staff-role-mark")} Модератор</div>
                      <h3>Soul</h3>
        ...
        <main id="rulesView" class="view">
          <section class="home">
            <div class="home-inner">
              <div class="badge">${glyph("rules", "badge-glyph")} Официальные правила сервера</div>
              ...
              <div class="choice-grid">
                ...
                <article class="choice bedrock">
                  <div class="icon">${glyph("bedrock")}</div>
        ...
        <main id="startView" class="view">
          <section class="site-page">
            ...
            <section class="page-hero">
              <div>
                <div class="badge">${glyph("launch", "badge-glyph")} Elysium START</div>
          ...
          <section class="site-page">
            ...
            <div class="donate-grid">
              <article class="donate-card">
                <div class="icon">${glyph("store")}</div>
                <h2>EasyDonate</h2>
                <p>
              ...
              <article class="donate-card">
                <div class="icon">${glyph("pulse")}</div>
            ...
            <section class="important">
              <h2>${glyph("warning", "heading-glyph")} Безопасность</h2>
              <p>
      ...
      return `
        <main id="${escapeHTML(key)}View" class="view">
          <section class="rules-page">
            ...
            <section class="important">
              <h2>${glyph("warning", "heading-glyph")} Важно</h2>
      ...
      <section class="account-page">
        <div class="account-shell account-shell-wide">
          ...
          <div class="account-heading">
            <div class="account-heading-mark" aria-hidden="true">${glyph("profile")}</div>
            <div>
          ...
          <section id="accountDashboard" class="account-dashboard account-dashboard-v2" hidden>
            ...
            <section id="accountBlocked" class="account-blocked account-blocked-compact" hidden>
              ...
              <div class="account-blocked-mark" aria-hidden="true">${glyph("block")}</div>
            ...
            <nav class="account-tabs" aria-label="Разделы личного кабинета">
              <button type="button" data-account-tab="overview" class="active">${glyph("overview", "account-tab-glyph")}<span>Обзор</span></button>
              <button type="button" data-account-tab="minecraft">${glyph("bedrock", "account-tab-glyph")}<span>Minecraft</span></button>
              <button type="button" data-account-tab="support">${glyph("support", "account-tab-glyph")}<span>Обращения</span></button>
              <button type="button" data-account-tab="appeals">${glyph("balance", "account-tab-glyph")}<span>Решения</span></button>
              <button type="button" data-account-tab="sessions">${glyph("sessions", "account-tab-glyph")}<span>Сеансы</span></button>
              <button type="button" data-account-tab="history">${glyph("history", "account-tab-glyph")}<span>История</span></button>
            </nav>

            <div class="account-tab-panels">
              <section class="account-tab-panel active" data-account-panel="overview">
                <div class="account-summary-grid">
                  <article class="summary-profile"><div class="account-summary-top">${glyph("profile", "account-summary-glyph")}<span>Статус профиля</span></div><strong id="accountSummaryStatus">Активен</strong><small id="accountSummaryStatusNote">Ограничений нет</small></article>
                  <article class="summary-minecraft"><div class="account-summary-top">${glyph("bedrock", "account-summary-glyph")}<span>Minecraft-аккаунты</span></div><strong id="accountSummaryAccounts">0 / 3</strong><small>Активных привязок</small></article>
                  <article class="summary-support"><div class="account-summary-top">${glyph("support", "account-summary-glyph")}<span>Открытые обращения</span></div><strong id="accountSummarySupport">0</strong><small>Поддержка и апелляции</small></article>
                  <article class="summary-sessions"><div class="account-summary-top">${glyph("sessions", "account-summary-glyph")}<span>Активные сеансы</span></div><strong id="accountSummarySessions">—</strong><small>Защищённые входы</small></article>
                </div>
              ...
              <section class="account-tab-panel" data-account-panel="minecraft" hidden>
                ...
                <div class="account-dashboard-grid">
                  <section class="account-accounts-panel">
                    ...
                    <div id="accountEmpty" class="account-empty" hidden>${glyph("bedrock", "account-empty-glyph")}<strong>Пока нет связанных ников</strong><p>Получите код при входе на сервер и добавьте его справа.</p></div>
                  </section>
              ...
              <section class="account-tab-panel" data-account-panel="support" hidden>
                ...
                <div class="account-two-column">
                  <section class="account-v2-panel">
                    ...
                    <div id="accountSupportEmpty" class="account-empty">${glyph("support", "account-empty-glyph")}<strong>Обращений пока нет</strong><p>Создайте обращение, если нужна помощь с профилем или сервером.</p></div>
                  </section>
              ...
              <section class="account-tab-panel" data-account-panel="appeals" hidden>
                ...
                <section class="account-v2-panel">
                  ...
                  <div id="accountDecisionEmpty" class="account-empty">${glyph("shield", "account-empty-glyph")}<strong>Активных решений нет</strong><p>Ваш профиль и Minecraft-аккаунты не ограничены.</p></div>
                </section>
                <form id="accountAppealComposer" class="account-v2-panel account-composer" novalidate hidden>
                  ...
                  <label>Обоснование<textarea id="accountAppealMessage" minlength="10" maxlength="4000" aria-describedby="accountAppealHint accountAppealStatus" placeholder="Почему решение стоит пересмотреть?" required></textarea></label>
                  <div id="accountAppealHint" class="account-field-hint">Ещё 10 симв. до отправки</div>
                  <div id="accountAppealStatus" class="account-link-status info" role="status" aria-live="polite" hidden></div>
                  <button id="accountAppealSubmit" class="main-btn green" type="submit" disabled>Подать апелляцию</button>
                </form>
      ...
      <section class="shield-page">
        <div class="shield-shell">
          ...
          <section id="shieldAccountHint" class="shield-account-hint" aria-live="polite">
            <div class="shield-account-hint-icon" aria-hidden="true">${glyph("profile")}</div>
