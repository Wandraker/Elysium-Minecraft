        ...
        <div class="account-shell">
          ...
          <div class="account-heading">
            ...
            <div>
              ...
              <p>
                Защищённый профиль Elysium, связанные Minecraft-аккаунты
                и история важных действий.
              </p>
            </div>
          </div>
          ...
          <section id="accountLoading" class="account-state-card">
            ...
            <div>
              ...
              <p>Соединяемся с Elysium Shield.</p>
            </div>
          </section>
          ...
          <section id="accountGuest" class="account-guest" hidden>
            <div class="account-guest-card">
              ...
              <div>
                <p class="account-kicker">ЗАЩИЩЁННЫЙ ВХОД</p>
                <h2>Войдите через Telegram</h2>
                <p>
                  Пароль на сайте создавать не нужно. Telegram подтвердит аккаунт,
                  а Elysium Shield выдаст защищённую сессию.
                </p>
              </div>
              <button id="accountLoginButton" class="account-login-button" type="button">
                <span>Войти через Telegram</span>
                <span aria-hidden="true">→</span>
              </button>
            </div>

            <div class="account-guest-note">
              Без авторизации Telegram подтверждение Minecraft-аккаунтов недоступно.
            </div>
          </section>

          <section id="accountDashboard" class="account-dashboard" hidden>
            <article class="account-profile-card">
              <div id="accountAvatar" class="account-profile-avatar">E</div>
              <div class="account-profile-copy">
                <p class="account-kicker">TELEGRAM PROFILE</p>
                <h2 id="accountDisplayName">Telegram</h2>
                <p id="accountUsername">Аккаунт Telegram</p>
              </div>
              <button id="accountLogoutButton" class="account-logout-button" type="button">
                Выйти
              </button>
            </article>

            <section id="accountBlocked" class="account-blocked" hidden>
              <div class="account-blocked-glow" aria-hidden="true"></div>
              <div class="account-blocked-mark" aria-hidden="true">✦</div>
              <p class="account-blocked-brand">ELYSIUM SHIELD</p>
              <h2>Доступ к профилю ограничен</h2>
              <p class="account-blocked-lead">
                Администрация Elysium ограничила использование этого профиля
                и связанных с ним Minecraft-аккаунтов.
              </p>
              <div class="account-blocked-details">
                <div>
                  <span>Причина</span>
                  <strong id="accountBlockReason">Нарушение правил сервера</strong>
                </div>
                <div>
                  <span>Срок</span>
                  <strong id="accountBlockExpires">Бессрочно</strong>
                </div>
                <div>
                  <span>Номер решения</span>
                  <strong id="accountBlockDecision">ES-SHIELD</strong>
                </div>
              </div>
              <p class="account-blocked-decision">Решение принято администрацией Elysium.</p>
              <div id="accountBlockedAccounts" class="account-blocked-accounts"></div>
            </section>

            <div id="accountActiveContent" class="account-active-content">
              <div class="account-dashboard-grid">
                <section class="account-accounts-panel">
                  <div class="account-panel-head">
                    <div>
                      <p class="account-kicker">MINECRAFT</p>
                      <h2>Связанные аккаунты</h2>
                    </div>
                    <div id="accountLimitBadge" class="account-limit-badge">0 из 3</div>
                  </div>

                  <div id="accountList" class="account-list"></div>
                  <div id="accountEmpty" class="account-empty" hidden>
                    <span aria-hidden="true">◇</span>
                    <strong>Пока нет связанных ников</strong>
                    <p>Получите код при входе на сервер и добавьте его справа.</p>
                  </div>
                </section>

                <section class="account-link-panel">
                  <p class="account-kicker">ДОБАВИТЬ НИК</p>
                  <h2>Привязать код</h2>
                  <p>
                    Введите одноразовый код, показанный Minecraft-сервером.
                    После Turnstile ник появится в этом профиле.
                  </p>
                  ...
                  <button id="accountLinkButton" class="main-btn green account-link-button" type="button">
                    Подтвердить и привязать
                  </button>

                  <div id="accountTurnstile" class="account-turnstile" hidden></div>
                  <div id="accountLinkStatus" class="account-link-status info" role="status" aria-live="polite">
                    Один профиль может содержать до трёх Minecraft-ников.
                  </div>
                  <button id="accountLinkRetry" class="main-btn secondary account-link-retry" type="button" hidden>
                    Повторить
                  </button>
                </section>
              </div>

              <section class="account-activity-panel">
                <div class="account-panel-head account-activity-head">
                  <div>
                    <p class="account-kicker">БЕЗОПАСНОСТЬ</p>
                    <h2>История профиля</h2>
                    <p>Критические действия сохраняются и отображаются всегда.</p>
                  </div>
                  <button id="accountActivityToggle" class="account-activity-toggle" type="button" aria-pressed="true">
                    Обычные события: включены
                  </button>
                </div>
                <div id="accountActivityList" class="account-activity-list"></div>
                <div id="accountActivityEmpty" class="account-activity-empty" hidden>
