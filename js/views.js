        ...
        <div class="account-shell">
          ...
          <div class="account-heading">
            ...
            <div>
              ...
              <p>
                Вход выполняется через Telegram. Здесь отображаются Minecraft-ники,
                подтверждённые через бота или через сайт после авторизации.
              </p>
            </div>
          </div>
          ...
          <section id="accountGuest" class="account-guest" hidden>
            ...
            <div class="account-guest-note">
              Верификация через Telegram-бота продолжает работать даже без входа на сайт.
            </div>
          </section>
          ...
          <section id="accountDashboard" class="account-dashboard" hidden>
            ...
            <div class="account-management-note">
              <b>Удаление и отвязка:</b> появятся в следующем обновлении вместе с административной панелью и синхронизацией кэша Minecraft-плагина.
            </div>
          </section>
        </div>
      </section>
      ...
      <section class="shield-page">
        <div class="shield-shell">
          ...
          <p class="shield-lead">
            ...
            Пароль Minecraft, Microsoft или Discord здесь не требуется.
          </p>
          ...
          <div class="shield-note">
            <b>Важно:</b>
            после успешной проверки вернитесь в Minecraft и подключитесь к серверу повторно.
          </div>
        </div>
      </section>
    </main>
