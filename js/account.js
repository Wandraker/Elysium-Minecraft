...
async function createConversation(kind) {
  ...
  if (isAppeal && body.message.length < 5) throw new Error("Напишите обоснование апелляции — минимум 5 символов.");
...
function initAccountActions() {
  ...
  document.getElementById("accountAppealSubmit")?.addEventListener("click", async (event) => {
